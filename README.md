...
## Πλοήγηση στις αλλαγές
Περιέχονται στο turnin όλα τα αρχεία που έχουν αλλάξει στους κατάλληλους
καταλόγους. Επίσης στο `extras/fair_scheduler.patch` υπάρχουν όλες οι αλλαγές
σε μορφή patch. Μπορείτε να τις εφαρμόσετε στο αρχικό branch R3.2.0 του Minix με `git
apply` ή `patch -p1`. Οι αλλαγές μου είναι αναλυτικά καταγεγραμμένες στο git
history δικού μου branch που μπορείτε να μου ζητήσετε αν το θέλετε.
